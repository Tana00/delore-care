      ...
      <div className="px-5 sm:px-10 lg:px-20 xl:px-40 max-w-[1920px] mx-auto w-full">
        ...
        <div className="flex items-start justify-between flex-col md:flex-row my-2">
          ...
          <div className="w-full md:w-[55%] xl:w-1/2">
            ...
            <button className="my-6 bg-white text-blue w-full min-[400px]:w-3/4 min-[500px]:w-3/5 sm:w-56 h-14 font-medium rounded-full text-base flex items-center justify-between px-4 border border-blue">
              <span>Read more</span>
              <Image
