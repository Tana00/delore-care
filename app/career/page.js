...
const Career = () => {
  return (
    <main className="bg-white font-gilmer">
      {/* Hero section */}
      <section className="bg-[url('/assets/images/career-hero.png')] bg-cover bg-bottom bg-no-repeat z-0 relative py-8 md:py-10 lg:py-28 h-auto 2xl:h-auto">
        <div className="grid items-start justify-between grid-cols-1 px-5 sm:px-10 lg:px-20 xl:px-40 max-w-[1920px] mx-auto w-full">
          <div className="text-center my-2 pt-[10rem] sm:pt-[15rem] lg:my-0">
            ...
            <p className="w-full md:w-4/5 lg:w-3/4 min-[2500px]:w-11/12 mx-auto text-white font-normal text-base md:text-lg lg:text-xl lg:!leading-9 min-[2500px]:text-[2.1rem] min-[2500px]:!leading-[70px] sm:!leading-8 my-2 md:my-4 2xl:my-8">
      ...
      <section className="grid items-start justify-between grid-cols-1 md:grid-cols-2 gap-10 lg:gap-20 p-5 sm:p-10 lg:px-20 xl:px-40 xl:pt-36 max-w-[1920px] mx-auto w-full">
        <div className="">
          <h2 className="text-blue font-bold text-[28px] lg:text-[36px] mb-4">
            Our Commitment to Excellence
          </h2>
          <p className="text-gray leading-8 text-base lg:text-lg 2xl:text-[1.5rem] xl:leading-[40px] 2xl:text-3xl 2xl:leading-[50px] font-normal">
        ...
        <div className="">
          ...
          <ul>
            {[
              ...
              <li className="py-4 border-b border-blue-200 flex items-center justify-between w-full">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-x-6">
            {[
              ...
              <li className="px-4 lg:px-10 py-6 sm:py-0 mb-5 border border-blue-light bg-blue-light flex flex-row items-center justify-between w-full h-[165px]">
                ...
                <Link href={`/career/${item.toLowerCase()}`} className="w-auto">
                  <div className="">
