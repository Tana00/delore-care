const TermsAndConditions = () => {
  return (
    <main className="bg-white font-gilmer backdrop-blur-xl bg-white/30">
      ...
      <section
        id="terms_of_service"
        className="p-5 sm:p-10 lg:p-20 xl:px-40 max-w-[1920px] mx-auto w-full"
      >
        <p>Welcome to Delore Care!</p>
        ...
        <p>
          ...
          conditions. Do not continue to use Delore Care if you do not agree to
        ...
        <p>
          ...
          accordance with and subject to, prevailing law of gb. Any use of the
        ...
        <p>
          We employ the use of cookies. By accessing Delore Care, you agreed to
          use cookies in agreement with the Delore Care's Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Delore Care and/or its licensors own the
          intellectual property rights for all material on Delore Care. All
          intellectual property rights are reserved. You may access this from
          Delore Care for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Delore Care</li>
          <li>Sell, rent or sub-license material from Delore Care</li>
          <li>Reproduce, duplicate or copy material from Delore Care</li>
          <li>Redistribute content from Delore Care</li>
        </ul>

        <p>
          Parts of this website offer an opportunity for users to post and
          exchange opinions and information in certain areas of the website.
          Delore Care does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Delore Care,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Delore Care
        ...
        <p>
          Delore Care reserves the right to monitor all Comments and to remove
        ...
        <p>
          You hereby grant Delore Care a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Delore Care; and (d) the link
        ...
        <p>
          ...
          sending an e-mail to Delore Care. Please include your name, your
        ...
        <p>
          No use of Delore Care's logo or other artwork will be allowed for
