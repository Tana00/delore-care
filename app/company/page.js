  ...
  return (
    <main className="bg-white font-gilmer">
      ...
      <section id="about-us" className="z-0 relative">
        <div className="bg-[url('/assets/images/about-hero-bg.svg')] bg-cover bg-no-repeat grid items-center justify-between grid-cols-1 lg:grid-cols-12 px-5 sm:px-10 lg:px-20 xl:px-40 max-w-[1920px] mx-auto w-full">
          <div className="text-center lg:text-left col-span-6 2xl:mr-36 my-10 lg:my-0">
            ...
            <p className="text-white font-light text-base md:text-lg 2xl:text-3xl 2xl:leading-[50px] leading-6 md:leading-8 my-4 2xl:my-8 mx-4 md:mx-20 lg:mx-0">
      ...
      <section id="our-mission" className="md:mb-20 md:mt-14">
        <div className="grid items-center justify-between grid-cols-1 lg:grid-cols-12 gap-24 px-5 sm:px-10 lg:px-20 xl:px-40 max-w-[1920px] mx-auto w-full">
          ...
          <div className="col-span-6">
            <div className="bg-blue-light p-3 rounded-full w-20 h-20">
              <img
            ...
            <p className="text-blue font-bold text-[40px] leading-[64px] my-8">
              Our Mission
            </p>
            <p className="text-gray leading-8 text-lg font-normal">
      ...
      {/* Our Vision */}
      <section id="our-vision" className="md:my-32">
        <div className="grid items-center justify-between grid-cols-1 lg:grid-cols-12 gap-24 px-5 sm:px-10 lg:px-20 xl:px-40 max-w-[1920px] mx-auto w-full">
          <div className="col-span-6">
            <div className="bg-blue-light p-3 rounded-full w-20 h-20">
              <img
      ...
      {/* Our Values */}
      <section id="our-values" className="py-[12rem] bg-blue-light">
        <div className="px-5 sm:px-10 lg:px-20 xl:px-40 max-w-[1920px] mx-auto w-full">
          <p className="text-blue font-bold text-[40px] leading-[64px] mb-8 text-center">
            Our Values
          </p>
          <div className="grid items-start justify-evenly grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
            {valueList?.map((value) => (
              <div
                key={value.id}
                className="text-center flex items-center justify-center flex-col h-[364px]"
              >
                ...
                <p className="text-2xl leading-[64px] font-semibold text-blue">
                  {value.title}
                </p>
                <p className="text-gray text-sm leading-9">{value.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Team */}
      <section id="team" className="my-24">
        <div className="px-5 sm:px-10 lg:px-20 xl:px-40 max-w-[1920px] mx-auto w-full">
          <p className="text-blue font-bold text-[40px] leading-[64px] mb-4 text-center">
            Meet The Team
          </p>
          ...
          <div className="grid items-start justify-evenly grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 2xl:gap-10 mt-20">
            {teamList.map((team) => (
            ...
            <div className="flex items-center justify-center lg:my-10">
              <div className="w-11/12 mx-auto lg:mr-auto 2xl:ml-0 py-10 text-center lg:text-left">
                ...
                <p className="text-white my-4 text-[15px] sm:text-base leading-7 sm:leading-8">
                  Got questions or need assistance? Our dedicated team is ready
                  to help. Reach out through our contact form, call us, or visit
                  us in person.
                </p>
