      ...
      <section id="about-us" className="z-0 relative">
        <div className="bg-blue-light relative">
          <div className="grid items-center justify-between grid-cols-1 lg:grid-cols-12 px-5 sm:px-10 lg:px-20 xl:px-40 max-w-[1920px] mx-auto w-full">
            <div className="text-center lg:text-left col-span-6 2xl:col-span-7 2xl:mr-36 mt-20 lg:mt-0">
              ...
              <p className="text-black text-base md:text-lg 2xl:text-xl 2xl:!leading-10 !leading-7 md:!leading-8 my-4 2xl:my-8 sm:mx-4 md:mx-20 lg:mx-0">
            ...
            <div className="col-span-6 2xl:col-span-5 w-full h-full">
