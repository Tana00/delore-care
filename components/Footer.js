...
const Footer = () => {
  return (
    <section className="bg-blue-light py-4 md:py-10 px-5 sm:px-10 lg:px-20 xl:px-40 mx-auto w-full font-gilmer">
      <div className="grid grid-cols-1 sm:grid-cols-[1fr_1fr] lg:grid-cols-[200px_minmax(200px,_1fr)_200px_200px] gap-y-8 items-start justify-between">
        <div className="">
          <Image
      ...
      <div className="w-full flex flex-col-reverse sm:flex-row items-center lg:justify-center justify-start gap-x-10 md:gap-20 text-blue font-medium py-4 md:py-10 lg:py-16">
        <p>© 2023 Delorecare</p>
